...
//------------------------------------------------------------------------------
    ...
    struct Button : Widget {
        Button(Point xy, int w, int h, const string& label, Callback cb, void* par)
            : Widget(xy,w,h,label,cb), parent(par)
        {}

		Button(Button& b) : Widget(b.loc, b.width, b.height, b.label, b.do_it), parent(b.parent)
		{}

		Button(Point xy, int w, int h, const string& label, Callback cb)
			: Widget(xy, w, h, label, cb), parent(nullptr)
		{}
